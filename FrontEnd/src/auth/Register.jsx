...
function Register() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(`${config.backendUrl}/register`, values)
      .then((res) => {
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 bg-gray-50 transition-all duration-200 hover:border-green-300 ${errors.confirmPassword ? "border-red-500" : "border-gray-200"
                  }`}
              />
              <button
                type="button"
